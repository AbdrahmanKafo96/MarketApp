                      ...
                      return Directionality(
                        ...
                        child: Dismissible(
                          ...
                          child: Column(
                            children: [
                              Container(
                                color:snapshot.data.docs[index]['readState']=='unRead'?
                                colorVar:Colors.white12,
                                child: ListTile(
                                  onTap: (){
                                    if(snapshot.data.docs[index]['readState']=='unRead')
                                    { FirebaseFirestore.instance
                                        .collection('Notices')
                                    ...
                                    if(snapshot.data.docs[index]['NoticesNumber']==3)
                                    {
                                      ...
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                Order(sellerID: sellerID,buyerID: buyerID,sellerRout: 'fromSeller',)),
                                      );
                                    }
                                  },// end ontap,
